...
export class App extends React.Component {
  ...
  getData = async (e) => {
    try {
      ...
      const weatherUrl = `https://city-explorer-sukina.herokuapp.com/weather?lat=${this.state.data.lat}&lon=${this.state.data.lon}`;
      ...
      const movieUrl = `https://city-explorer-sukina.herokuapp.com/movie?query=${this.state.locationName}`;
